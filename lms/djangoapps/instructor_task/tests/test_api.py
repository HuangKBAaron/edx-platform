...
class InstructorTaskModuleSubmitTest(InstructorTaskModuleTestCase):
    ...
    @ddt.data(
        ...
        (submit_rescore_problem_for_all_students, 'rescore_problem_if_higher', dict(only_if_higher=True)),
        (submit_rescore_problem_for_student, 'rescore_problem', dict(student=True)),
        (submit_rescore_problem_for_student, 'rescore_problem_if_higher', dict(student=True, only_if_higher=True)),
        ...
        (submit_rescore_entrance_exam_for_student, 'rescore_problem', dict(student=True)),
        (
            submit_rescore_entrance_exam_for_student,
            'rescore_problem_if_higher',
            dict(student=True, only_if_higher=True),
        ),
        (submit_reset_problem_attempts_in_entrance_exam, 'reset_problem_attempts', dict(student=True)),
        (submit_delete_entrance_exam_state_for_student, 'delete_problem_state', dict(student=True)),
    )
    @ddt.unpack
